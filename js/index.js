$(function(){
  $('#fullpage').fullpage({
    sectionsColor:['#fadd67','#84a2d4','#ef674d','#ffeedd','#d04759','#84d9ed','#4ffdded'],
    navigation:true,
       ...
       $(".qbh-list-computer .search-box").animate({"opacity": 1,"right":180},1000,function(){
          ...
          //  $(".qbh-list-word img:first-child").animate({"opacity":0},1000);
           ...
           $(".qbh-list-search-finish").show().animate({
            ...
            "width":156
               ...
               $(".qbh-list-sofas").animate({"width":441
              },1000);
           })   
         })
        }
         ...
         if(index == 2 && nextIndex == 3){
          $(".qbh-list .qbh-list-sofa-pic").show().animate({
            ...
            $(".qbh-buy .qbh-buy-main .no-choose").animate({
              "opacity": 0
            });

            $(".qbh-buy .qbh-buy-main .choose").animate({
              "opacity": 1
            });
